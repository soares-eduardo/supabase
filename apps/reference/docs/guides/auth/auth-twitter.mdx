...
First of all, you need an "elevated access" to be able to access e-mail adresses. To have this elevated access you need to submit a brief description of the 
project to Twitter and wait for them to review it.
